  ...
  return (
    <Card className="bg-gradient-to-r from-purple-500 to-pink-500 text-white mb-8">
      <CardContent className="p-6">
        <h1 className="text-3xl font-bold mb-4">Welcome to FashionHub</h1>
        <p className="text-lg mb-4">
          FashionHub is a free platform designed to foster relationships and help you plan your next collection.
        </p>
